...
print(energy >= HILLDESCENT_RANDOM_UPHILL(maze,start_state,goal_state,00,0.03)[1])
print(energy >= SIMULATED_ANNEALING(maze,start_state,goal_state,100,1000,0.98)[1])
